...
public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
{
	...
	/// <summary>
	/// 1:N bshcs_contact_incident_caller
	/// </summary>
	[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bshcs_contact_incident_caller")]
	public System.Collections.Generic.IEnumerable<Incident> bshcs_contact_incident_caller
	{
		get
		{
			return this.GetRelatedEntities<Incident>("bshcs_contact_incident_caller", null);
		}
		set
		{
			this.OnPropertyChanging("bshcs_contact_incident_caller");
			this.SetRelatedEntities<Incident>("bshcs_contact_incident_caller", null, value);
