...
public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
{
		...
		public partial class Fields
		{
			...
			public const string bshcs_accounttype = "bshcs_accounttype";
			public const string bshcs_corpname = "bshcs_corpname";
			public const string bshcs_corpname2 = "bshcs_corpname2";
			public const string bshcs_firstname = "bshcs_firstname";
			public const string bshcs_lastname = "bshcs_lastname";
			public const string bshcs_mainaddressid = "bshcs_mainaddressid";
			public const string bshcs_originatingbusinessunitid = "bshcs_originatingbusinessunitid";
			public const string bshcs_taxnumber = "bshcs_taxnumber";
	...
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_accounttype")]
	public virtual bshcs_accounttype? bshcs_accounttype
	{
		get
		{
			return ((bshcs_accounttype?)(EntityOptionSetEnum.GetEnum(this, "bshcs_accounttype")));
		}
		set
		{
			this.OnPropertyChanging("bshcs_accounttype");
			this.SetAttributeValue("bshcs_accounttype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			this.OnPropertyChanged("bshcs_accounttype");
		}
	}
	
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_corpname")]
	public string bshcs_corpname
	{
		get
		{
			return this.GetAttributeValue<string>("bshcs_corpname");
		}
		set
		{
			this.OnPropertyChanging("bshcs_corpname");
			this.SetAttributeValue("bshcs_corpname", value);
			this.OnPropertyChanged("bshcs_corpname");
		}
	}
	
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_corpname2")]
	public string bshcs_corpname2
	{
		get
		{
			return this.GetAttributeValue<string>("bshcs_corpname2");
		}
		set
		{
			this.OnPropertyChanging("bshcs_corpname2");
			this.SetAttributeValue("bshcs_corpname2", value);
			this.OnPropertyChanged("bshcs_corpname2");
		}
	}
	
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_firstname")]
	public string bshcs_firstname
	{
		get
		{
			return this.GetAttributeValue<string>("bshcs_firstname");
		}
		set
		{
			this.OnPropertyChanging("bshcs_firstname");
			this.SetAttributeValue("bshcs_firstname", value);
			this.OnPropertyChanged("bshcs_firstname");
		}
	}
	
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_lastname")]
	public string bshcs_lastname
	{
		get
		{
			return this.GetAttributeValue<string>("bshcs_lastname");
		}
		set
		{
			this.OnPropertyChanging("bshcs_lastname");
			this.SetAttributeValue("bshcs_lastname", value);
			this.OnPropertyChanged("bshcs_lastname");
		}
	}
	
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_mainaddressid")]
	public Microsoft.Xrm.Sdk.EntityReference bshcs_mainaddressid
	{
		get
		{
			return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("bshcs_mainaddressid");
		}
		set
		{
			this.OnPropertyChanging("bshcs_mainaddressid");
			this.SetAttributeValue("bshcs_mainaddressid", value);
			this.OnPropertyChanged("bshcs_mainaddressid");
		}
	}
	
	/// <summary>
	/// Load the business unit id from the conversation.
	/// </summary>
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_originatingbusinessunitid")]
	public Microsoft.Xrm.Sdk.EntityReference bshcs_originatingbusinessunitid
	{
		get
		{
			return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("bshcs_originatingbusinessunitid");
		}
		set
		{
			this.OnPropertyChanging("bshcs_originatingbusinessunitid");
			this.SetAttributeValue("bshcs_originatingbusinessunitid", value);
			this.OnPropertyChanged("bshcs_originatingbusinessunitid");
		}
	}
	
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_taxnumber")]
	public string bshcs_taxnumber
	{
		get
		{
			return this.GetAttributeValue<string>("bshcs_taxnumber");
		}
		set
		{
			this.OnPropertyChanging("bshcs_taxnumber");
			this.SetAttributeValue("bshcs_taxnumber", value);
			this.OnPropertyChanged("bshcs_taxnumber");
		}
	}
	...
	/// <summary>
	/// 1:N bshcs_account_incident_caller
	/// </summary>
	[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bshcs_account_incident_caller")]
	public System.Collections.Generic.IEnumerable<Incident> bshcs_account_incident_caller
	{
		get
		{
			return this.GetRelatedEntities<Incident>("bshcs_account_incident_caller", null);
		}
		set
		{
			this.OnPropertyChanging("bshcs_account_incident_caller");
			this.SetRelatedEntities<Incident>("bshcs_account_incident_caller", null, value);
			this.OnPropertyChanged("bshcs_account_incident_caller");
		}
	}
	
	/// <summary>
	/// 1:N bshcs_account_msdyn_functionallocation
	/// </summary>
	[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bshcs_account_msdyn_functionallocation")]
	public System.Collections.Generic.IEnumerable<msdyn_FunctionalLocation> bshcs_account_msdyn_functionallocation
	{
		get
		{
			return this.GetRelatedEntities<msdyn_FunctionalLocation>("bshcs_account_msdyn_functionallocation", null);
		}
		set
		{
			this.OnPropertyChanging("bshcs_account_msdyn_functionallocation");
			this.SetRelatedEntities<msdyn_FunctionalLocation>("bshcs_account_msdyn_functionallocation", null, value);
			this.OnPropertyChanged("bshcs_account_msdyn_functionallocation");
		}
	}
	
	/// <summary>
	/// 1:N bshcs_billingfunctionallocation_account
	/// </summary>
	[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bshcs_billingfunctionallocation_account")]
	public System.Collections.Generic.IEnumerable<bshcs_billingFunctionalLocation> bshcs_billingfunctionallocation_account
	{
		get
		{
			return this.GetRelatedEntities<bshcs_billingFunctionalLocation>("bshcs_billingfunctionallocation_account", null);
		}
		set
		{
			this.OnPropertyChanging("bshcs_billingfunctionallocation_account");
			this.SetRelatedEntities<bshcs_billingFunctionalLocation>("bshcs_billingfunctionallocation_account", null, value);
	...
	public System.Collections.Generic.IEnumerable<msdyn_FunctionalLocation> msdyn_msdyn_functionallocation_account
	{
		get
		{
			return this.GetRelatedEntities<msdyn_FunctionalLocation>("msdyn_msdyn_functionallocation_account", null);
		}
		set
		{
			this.OnPropertyChanging("msdyn_msdyn_functionallocation_account");
			this.SetRelatedEntities<msdyn_FunctionalLocation>("msdyn_msdyn_functionallocation_account", null, value);
	...
	/// <summary>
	/// N:1 bshcs_account_mainaddressid_msdyn_functionallocation
	/// </summary>
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bshcs_mainaddressid")]
	[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bshcs_account_mainaddressid_msdyn_functionallocation")]
	public msdyn_FunctionalLocation bshcs_account_mainaddressid_msdyn_functionallocation
	{
		get
		{
			return this.GetRelatedEntity<msdyn_FunctionalLocation>("bshcs_account_mainaddressid_msdyn_functionallocation", null);
		}
		set
		{
			this.OnPropertyChanging("bshcs_account_mainaddressid_msdyn_functionallocation");
			this.SetRelatedEntity<msdyn_FunctionalLocation>("bshcs_account_mainaddressid_msdyn_functionallocation", null, value);
